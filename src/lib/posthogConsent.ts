...
/**
 * Track error (minimal, allowed for necessary purposes)
 */
export function trackError(posthog: PostHog, error: string, context?: Record<string, unknown>): void {
  // Always allowed for necessary error tracking
  captureEvent(posthog, 'error_occurred', {
    error_message: error,
