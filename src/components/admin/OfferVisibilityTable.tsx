                                ...
                                <TableRow key={offer.id} className="hover:bg-muted/5">
                                    ...
                                    <TableCell>
                                        <div className="flex items-center gap-3">
                                            <div className="h-10 w-10 rounded-lg bg-muted/30 border flex items-center justify-center overflow-hidden flex-shrink-0">
                                                {offer.logo ? (
                                                    <img src={offer.logo} alt={offer.name} className="h-full w-full object-contain p-1" />
                                                ) : (
