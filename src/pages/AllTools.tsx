...
const AllTools = () => {
  ...
  const {
    ...
    handleFilterChange, // This is for single toggle if needed, but we use handleTagsChange for the bar
    handlePageChange,
    handleSortChange,
  ...
  return (
    <div style={{ overflow: 'visible' }}>
      ...
      <div className={cn("container py-6 md:py-10 transition-all duration-300", isGitHubCategory && "pb-32 sm:pb-28")}>
        ...
        {showLoadingState && <OfferGridLoadingState count={12} />}
