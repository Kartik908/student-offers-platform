  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="w-full py-8 sm:py-10 md:py-12 lg:py-16 px-4 sm:px-6 md:px-8 lg:px-12 max-w-5xl mx-auto">
        ...
        {/* TL;DR */}
        <div className="bg-primary/10 border border-primary/30 rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 mb-8 sm:mb-10 md:mb-12 hover:bg-primary/15 transition-colors">
        ...
        {/* Sections */}
        <div className="space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-12 [&_p]:max-w-3xl [&_section]:hover:bg-card/50 [&_section]:transition-colors [&_h2]:mb-3 [&_h2]:sm:mb-4">
          {/* 1. Manual Review */}
          <section className="bg-card/30 rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border border-border/50">
